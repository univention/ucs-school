...
async def test_create(
    ...
    async with UDM(**udm_kwargs) as udm:
        ...
        if role.name == "staff":
            assert user_udm.props.profilepath == None
            assert user_udm.props.sambahome == None
        else:
            assert user_udm.props.profilepath == "%LOGONSERVER%\%USERNAME%\windows-profiles\default"
            ...
            assert home_share_file_server, f"No 'home_share_file_server' set for OU {lib_users[0].school!r}."
