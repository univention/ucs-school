...
dojo.provide("umc.modules.school-groups");
...
dojo.require("umc.modules._school-groups.DetailPage");

dojo.declare("umc.modules.school-groups", [ umc.widgets.Module, umc.i18n.Mixin ], {
	// summary:
	...
	renderSearchPage: function(containers, superordinates) {
		...
		this._detailPage = new umc.modules._school-groups.DetailPage({
			moduleStore: this.moduleStore
		});
