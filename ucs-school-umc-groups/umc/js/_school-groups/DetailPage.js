...
dojo.provide("umc.modules._school-groups.DetailPage");
...
dojo.declare("umc.modules._school-groups.DetailPage", [ umc.widgets.Page, umc.widgets.StandbyMixin, umc.i18n.Mixin ], {
	// summary:
	...
	// use i18n information from umc.modules.school-groups
	i18nClass: 'umc.modules.school-groups',
	...
	renderDetailPage: function() {
		...
		var widgets = [{
			...
			dynamicValues: 'school-groups/colors'
		}];
