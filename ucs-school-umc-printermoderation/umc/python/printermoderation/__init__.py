...
class Instance( Base ):
	...
	def colors( self, request ):
		...
		MODULE.info( 'printermoderation.colors: options: %s' % str( request.options ) )
		...
		MODULE.info( 'printermoderation.colors: result: %s' % str( allColors ) )
	...
	def query( self, request ):
		...
		"""
		MODULE.info( 'printermoderation.query: options: %s' % str( request.options ) )
		...
		MODULE.info( 'printermoderation.query: results: %s' % str( result ) )
