...
dojo.provide("umc.modules.schoolrooms");
...
dojo.require("umc.modules._schoolrooms.DetailPage");

dojo.declare("umc.modules.schoolrooms", [ umc.widgets.Module, umc.i18n.Mixin ], {
	// summary:
	...
	renderSearchPage: function(containers, superordinates) {
		...
		var actions = [{
			name: 'add',
			label: this._('Add room'),
			description: this._('Create a new room'),
		...
		this._detailPage = new umc.modules._schoolrooms.DetailPage({
			moduleStore: this.moduleStore
		});
