...
## -*- coding: utf-8 -*-
## desc: check performance of POST /ucsschool/bff-groups/v1/groups/school_class/
...
LOCUST_USER_CLASS = "CreateGroupClass"
RESULT_FILES_NAME = "bff-groups-groups-class-post"
...
URL_NAME = "/ucsschool/bff-groups/v1/groups/school_class/"
...
# is: The time to create a class must be below 2 seconds.
