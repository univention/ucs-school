...
## -*- coding: utf-8 -*-
## desc: check performance of DELETE /ucsschool/bff-users/v1/users/[name]
...
LOCUST_USER_CLASS = "DeleteUser"
RESULT_FILES_NAME = "bff-users-users-delete"
...
# is: The time to delete a user must be below 2 seconds.
