...
## -*- coding: utf-8 -*-
## desc: check performance of GET /ucsschool/bff-users/v1/pages/listView/settings/[username]
...
RESULT_FILES_NAME = "bff-users-pages-listView-settings-get"
URL_NAME = "/ucsschool/bff-users/v1/pages/listView/settings/[username]"
...
# is: The time to get the listView must be below 2 seconds.
