...
## -*- coding: utf-8 -*-
## desc: check performance of GET /ucsschool/bff-users/v1/users/detail/[name]
...
LOCUST_USER_CLASS = "GetUser"
RESULT_FILES_NAME = "bff-users-users-get"
...
# is: The time to get a user must be below 1 seconds.
...
def test_rps(check_rps, run_test):
    check_rps(RESULT_FILE_BASE_PATH, URL_NAME, 1)
