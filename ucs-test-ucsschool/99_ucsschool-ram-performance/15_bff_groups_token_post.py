...
## -*- coding: utf-8 -*-
## desc: check performance of POST /ucsschool/bff-groups/v1/token
...
LOCUST_USER_CLASS = "GetToken"
RESULT_FILES_NAME = "bff-groups-token-post"
URL_NAME = "/ucsschool/bff-groups/v1/token"
