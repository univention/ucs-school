...
## -*- coding: utf-8 -*-
## desc: check performance of GET /ucsschool/bff-users/v1/users/search/[school]
...
LOCUST_USER_CLASS = "UserSearchGet"
RESULT_FILES_NAME = "bff-users-users-search-get"
URL_NAME = "/ucsschool/bff-users/v1/users/search/[school]"
...
# is: The time to search a user must be below 2 seconds.
