		...
		names = [
			{
				...
				'expected': {'username': 'y.muestermann', 'firstname': 'Ýlang', 'lastname': 'Müstèrmánn'},
			},
			{
				'firstname': u'Öle',
			...
			},
			{
				...
				'expected': {'username': 'n.muesterfraeu', 'firstname': 'Nînä', 'lastname': 'Müstèrfräú'},
			},
			{
				'firstname': u'Ǹanâ',
				'lastname': u'Mästérfrâü',
				'expected': {'username': 'n.maesterfraue', 'firstname': 'Ǹanâ', 'lastname': 'Mästérfrâü'},
			}
		]
