...
def main():
	with utu.UCSTestSchool() as schoolenv:
		with ucr_test.UCSTestConfigRegistry() as ucr:
			...
			rule1 = InternetRule(ucr=ucr, connection=client, typ='whitelist', domains=['univention.de'], priority=3)
			rule1.define()
			...
			rule2 = InternetRule(ucr=ucr, connection=client, typ='whitelist', domains=['google.de', 'gmx.net'], priority=4)
			rule2.define()
