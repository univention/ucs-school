...
def setRandomDisplayNameViaCreateOU(ou_name):
	...
	cmd = ['/usr/share/ucs-school-import/scripts/create_ou', '--verbose', '--displayName', ou_displayName, ou_name]
	...
	utils.verify_ldap_object(ou_dn, expected_attr={'ou': [ou_name], 'displayName': [ou_displayName]}, strict=True, should_exist=True)
