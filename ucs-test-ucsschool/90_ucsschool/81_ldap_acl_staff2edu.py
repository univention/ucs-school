...
class TestCases(object):
	def __init__(self, ucr, schoolenv):
		...
		self.admin1 = MyObj(*self.schoolenv.create_school_admin(self.school1.name, is_teacher=True, wait_for_replication=False))
		self.admin2 = MyObj(*self.schoolenv.create_school_admin(self.school2.name, schools=[self.school1.name, self.school2.name], is_teacher=True, wait_for_replication=False))
