...
class Test(CLI_Import_v2_Tester):
	...
	def test(self):
		...
		self.log.info('*** Importing a %r, no configuration test, no birthday mapping -> no exception...', role)
		...
		self.log.info('*** Importing same %r, activating check, no birthday mapping -> no exception...', role)
		...
		self.log.info('*** Importing same %r, activating check, configuration test should raise an exception...', role)
