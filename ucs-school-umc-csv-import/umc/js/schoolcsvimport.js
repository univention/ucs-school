	...
	var UploadWizard = declare('umc.modules.schoolcsvimport.Wizard', Wizard, {
		...
		postMixInProperties: function() {
			...
			this.pages = [{
				...
				helpText: _('This assistant guides through the individual steps for importing school users with a CSV file. At first, the user role for the users from the CSV file needs to be specified.'),
				widgets: [{
					type: ComboBox,
					name: 'school',
					label: _('School'),
