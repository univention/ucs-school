...
class MassImport(object):
    ...
    def import_users(self):  # type: () -> None
        ...
        try:
            ...
            run_import_pyhooks(PreReadPyHook, "pre_read", supports_dry_run=filter_func)
        ...
        run_import_pyhooks(ResultPyHook, "user_result", result_data, supports_dry_run=filter_func)
