...
class HttpApiCsvReader2(CsvReader):
	def __init__(self):
		...
		super(HttpApiCsvReader2, self).__init__(filename, header_lines)
		self.config = Configuration()
	...
	def handle_input(self, mapping_key, mapping_value, csv_value, import_user):
		...
		if mapping_value == 'school_classes':
			...
			return True
		return super(HttpApiCsvReader2, self).handle_input(mapping_key, mapping_value, csv_value, import_user)
