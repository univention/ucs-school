...
def main():  # type: () -> None
    ...
    print("Results:")
    print(
        "Seconds for creating   {} Users: {:02.2f} ({:02.2f}/user)".format(
            NUM_USERS, t_1000_1, t_1000_1 / NUM_USERS
        )
    )
    print(
        "Seconds for reading    {} Users: {:02.2f} ({:02.2f}/user)".format(
            NUM_USERS, t_1000_2, t_1000_2 / NUM_USERS
        )
    )
    print(
        "Seconds for modifying  {} Users: {:02.2f} ({:02.2f}/user)".format(
            NUM_USERS, t_1000_3, t_1000_3 / NUM_USERS
        )
    )
    print(
        "Seconds for deleting   {} Users: {:02.2f} ({:02.2f}/user)".format(
            NUM_USERS, t_1000_4, t_1000_4 / NUM_USERS
        )
    )
