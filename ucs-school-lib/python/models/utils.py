...
def _ucr():  # type: () -> univention.config_registry.ConfigRegistry
	ucr = ConfigRegistry()
	ucr.load()
	return ucr
...
ucr = lazy_object_proxy.Proxy(_ucr)  # type: univention.config_registry.ConfigRegistry # "global" ucr for ucsschool.lib.models
