...
needed_screenshots = [
    ...
    Screenshot(
        "computerroom_3_start_presentation",
        [Lang.DE, Lang.FR],
        desc="Start des Präsentationsmodus bestätigen",
    ),
    Screenshot("computerrooms_1_overview", [Lang.DE, Lang.FR], desc="Computerraum verwalten"),
    Screenshot(
        "computerrooms_2_add_computers", [Lang.DE, Lang.FR], desc="Computerraum Computer hinzufügen"
    ),
    ...
    Screenshot(
        "exam_1_reboot",
        [Lang.DE, Lang.FR],
        desc="Neustart der Rechner für Klassenarbeitsmodus bestätigen",
    ),
    Screenshot(
        "exam_2_computerroom", [Lang.DE, Lang.FR], desc="Computerraum während einer Klassenarbeit"
    ),
    ...
    Screenshot(
        "module_overview_Administrator_admin",
        [Lang.DE, Lang.FR, Lang.EN],
        desc="Modulübersicht Verwaltung als Administrator",
    ),
    ...
    Screenshot(
        "passwords_students_1", [Lang.DE, Lang.FR, Lang.EN], desc="Passwörter zurücksetzen Übersicht"
    ),
    Screenshot(
        "passwords_students_2",
        [Lang.DE, Lang.FR, Lang.EN],
        desc="Passwörter zurücksetzen Übersicht, Auswahl Klasse",
    ),
    Screenshot(
        "passwords_students_3", [Lang.DE, Lang.FR, Lang.EN], desc="Dialogfenster zum Passwortreset"
    ),
    Screenshot(
        "passwords_students_4",
        [Lang.DE, Lang.EN],
        desc="Passwörter zurücksetzen, Hintergrund Liste der Schüler, Vordergrund Reset-Dialog",
    ),
    Screenshot(
        "portal_ucsschool",
        [Lang.DE, Lang.EN],
        desc="UCS Portalseite mit UCS@school und Icons für Mail, Dateitausch, Lernplattform",
    ),
    ...
    Screenshot(
        "workgroup_2_add_students", [Lang.DE, Lang.FR], desc="Schüler einer Arbeitsgruppe hinzufügen"
    ),
]
