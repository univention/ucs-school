...
Bei Neuinstallation einer UCS@school 3.1 R2 Domäne mit Samba 4 sollte nach Abschluss der Installation einmalig als \emph{root}-Benutzer ucsCommand{samba-tool ntacl sysvolreset} auf der Kommandozeile ausgeführt werden.
...
\input{changelog-ucsschool-3.1R2}
