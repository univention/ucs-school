...
\item The LDAP ACLs have been adaptet to be more restrictive (\ucsBug{31299}).
\end{itemize}
...
\item The "Stop presentation" has been moved above the grid (\ucsBug{31336}).
\item The "Lock screen" button has been moved into the statusbar (\ucsBug{31335}).
\end{itemize}
