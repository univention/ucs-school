...
\item A new UMC module for school exams has been added along with an extension
  ...
  \ucsBug{30832}, \ucsBug{30833}, \ucsBug{30835}, \ucsBug{30834}, \ucsBug{31156}, \ucsBug{31164}, \ucsBug{31163}, \ucsBug{31389}, \ucsBug{31158}).
...
\item The \ucsName{Computer room} module can now only be opened once, a second
  click on its icon on the \ucsName{UMC} overview page focusses the existing
  tab.  The behaviour has been adapted as multiple module tabs could lead to
  inconsistencies in displaying the correct computer states (\ucsBug{31454}).
\end{itemize}
