...
\begin{itemize}
\item Fixed detection whether the user of a connected iTALC client is a teacher. The detection had failed if previously a student was logged in (\ucsBug{32035}).
\end{itemize}
