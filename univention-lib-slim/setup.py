...
PIP_FALLBACK_URL = "https://raw.githubusercontent.com/univention/univention-corporate-server/4.4-1/base/univention-lib/debian/changelog"
...
setuptools.setup(
    ...
    description="Univention-lib Python modules",
    long_description="Univention-lib Python modules",
    url="https://www.univention.de/",
    install_requires=requirements,
    packages=["univention.lib"],
